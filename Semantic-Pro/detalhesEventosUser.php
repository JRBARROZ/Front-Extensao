			...
			<div class="ui segment">
				...
				<div class="ui equal width grid">
					<div class="three wide row">
						<div class="column"><a href=""><div class="ui green fluid button"><i class="edit icon"></i>Editar evento</div></a></div>	
						<div class="column"><a href=""><div class="ui green fluid button"><i class="plus icon"></i>Adicionar Atividades</div></a></div>	
						<div class="column"><a href="confirmacao.php"><div class="ui green fluid button"><i class="user icon"></i>Gerenciar participantes</div></a></div>	
						<div class="column"><a href=""><div class="ui green fluid button"><i class="close icon"></i>Excluir evento</div></a></div>	
					</div>
				</div>
			</div>
		</div>
